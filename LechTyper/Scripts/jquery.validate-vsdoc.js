...
$.extend($.validator, {
	...
	messages: {
		...
		remote: "Uzupełnij poprawnie to pole.",
		...
		maxlength: $.validator.format("Wpisz poniżej {0} znaków."),
		minlength: $.validator.format("Podaj minimum {0} znaki."),
		rangelength: $.validator.format("Podaj tekst o długości miedzy {0} i {1} znaków."),
